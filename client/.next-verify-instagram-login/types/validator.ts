...
// Validate ../../app/(dashboard)/conversation/[id]/page.tsx
{
  type __IsExpected<Specific extends AppPageConfig<"/conversation/[id]">> = Specific
  const handler = {} as typeof import("../../app/(dashboard)/conversation/[id]/page.js")
  type __Check = __IsExpected<typeof handler>
  // @ts-ignore
  type __Unused = __Check
}
